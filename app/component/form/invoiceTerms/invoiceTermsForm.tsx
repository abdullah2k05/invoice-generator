...
const MobileDateField = ({ label, variableName }: { label: string; variableName: string }) => (
  <Controller
    render={({ field: { onChange, value } }) => (
      <div className="relative w-full border border-gray-200 rounded-xl bg-white px-4 pt-5 pb-2 h-[60px] focus-within:border-orange-500 focus-within:ring-1 focus-within:ring-orange-500 transition-all">
